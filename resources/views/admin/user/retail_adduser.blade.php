        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="user-add-sec">
                    <form action="{{ route('admin.retail.apidata') }}" id="user_create" role="form" method="get"
                        class='prevent_multiple_submit_details' files=true enctype='multipart/form-data'
            ...
            <div class="card border-primary m-3 file-upload-sec">
                <div class="row" style="margin-top: 2vh;margin-right: 5vh;margin-bottom: 2vh; text-align:right;">
                    <div class="col-md-12">
                        <a href="{{ asset('csv_sample/retail_upload_Sample.csv') }}">Sample CSV file </a>
                    </div>
                </div>
                <div class="card-body m-4">
                    <form action="{{ route('admin.company_bulk.retail.store') }}" role="form" method="post"
                        class='prevent_multiple_submit-upload' files=true enctype='multipart/form-data'
                        accept-charset="utf-8">
                        @csrf
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right" rowspan="2">
                                        ...
                                        <button type="submit" id="submit-upload"
                                            class="btn btn-2 company-btn btn-primary btn-sm form-control form-control-sm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.prevent_multiple_submit_details').on('submit', function(event) {
                ...
                $('#det').html(
                    '<div class="offset-md-4 msg1"><span class="text-danger text-sm text-center">Please wait while your request is being processed. &nbsp&nbsp&nbsp<i class="fa fa-spinner fa-spin" style="font-size:24px;color:black"></i></span></div>'
                    );
            ...
            $('.prevent_multiple_submit-upload').on('submit', function() {
                $(".prevent_multiple_submit-upload").parent().append(
