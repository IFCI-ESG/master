    ...
    <div class="container  py-4 px-2 col-lg-12">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="{{ route('admin.retail.existsubmit') }}" id="retail_update" role="form" method="post"
                                            ...
                                            <td colspan="2">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="co_off_pin"
                                                            ...
                                                            <input type="number" min="0" id="co_off_pin" name="pincode"
                                                                class="form-control form-control-sm" placeholder="Pin Code" disabled
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm select-state" disabled
