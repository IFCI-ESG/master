  ...
  @if(session('success'))
    ...
    <div class="container  py-4 px-2 col-lg-12">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="{{ route('admin.user.existsubmit') }}" id="user_create" role="form" method="post"
                    ...
                    <div class="card border-primary m-2" id="result">
                        ...
                        <div class="card border-primary m-2">
                         <div class="card  card-outline shadow p-1 card-header-black" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%;">
                                                ...
                                                {{-- <select name="comp_type" id="type" readonly class="form-control form-control-sm comp_det">
                                                    @foreach ($type as $ty)
                                                        <option value="{{ $ty->id }}"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                {{-- <select name="sector" id="sector" readonly class="form-control form-control-sm comp_det">
                                        ...
                                        @foreach ($financial as $key=>$fin)
                                            <tr>
                                                <th colspan="2" class="text-center">
                                                    FY {{$fin->fy}}
                                                    <input type="hidden" name="fy[{{$key}}][fy_id]" value="{{$fin->fy_id}}">
                                                </th>
                                            </tr>
                                            <tr>
                                                <th>Rating</th>
