...
<div class="alert alert-success alert-dismissible bg-danger text-white border-0 fade show" role="alert">
    ...
    <!-- Buttons: Update and Submit -->
    <div class="col-md-4 d-flex justify-content-center">
        <!-- Update Button -->
        <button type="submit" id="save_submit" class="btn btn-primary btn-sm form-control form-control-sm me-3">
            <em class="fas fa-save"></em>&nbsp; Update
        </button>

        <!-- Submit Button -->
        <form action="{{ route('admin.new_admin.submit') }}" id="final_submit" method="post" class="fin_prevent_multiple_submit" enctype="multipart/form-data" accept-charset="utf-8">
            @csrf
