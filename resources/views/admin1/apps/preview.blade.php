                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(isset($app_upload->where('app_id', $appMast->id)->where('doc_id',$docMast->doc_id)->first()->upload_id[0]))
                                                                <a href="{{ route('admin.download.file', $app_upload->where('app_id', $appMast->id)->where('doc_id',$docMast->doc_id)->first()->upload_id[0] ) }}" class="btn btn-sm btn-info" target=""> View </a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
