                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="temp_employee" id="temp_employee" style="width:50%"
                                                class="form-control form-control-sm valid" value="{{$additional->temp_employee}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="prod_capacity" id="prod_capacity" style="width:50%"
                                                class="form-control form-control-sm valid" value="{{$additional->prod_capacity}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" min="0" id="reg_off_pin"
                                                        ...
                                                        placeholder="Pin Code" value="{{$additional->pincode}}"
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm select-state"
                                                        name="state" id="regAddState"  value="{{$additional->state}}" readonly>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select id="regAddCity" name="city"
                                                        ...
                                                        <option value="{{$additional->city}}" selected="selected">{{$additional->city}}</option>
                                                    </select>
                                                </div>
