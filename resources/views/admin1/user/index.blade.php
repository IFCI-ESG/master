...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-default" href="{{ route('admin.adduser') }}"> Corporate Borrower </a>
            <a class="btn btn-default" href="{{ route('admin.retail.adduser') }}"> Retail Borrower </a>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="card border-primary mt-3">
                <div class="card card-success card-outline shadow p-1">
                   <h5 class="card-title">Retail Borrowers</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="example" class="table table-sm table-striped table-hover">
                                    ...
                                    <tbody>
                                        @if ($retail_detail)
                                            @foreach ($retail_detail as $key => $user)
                                                <tr>
                                                    <td class="text-center">{{ $key + 1 }}</td>
                                                    <td class="text-center">{{$user->name}}</td>
                                                    <td class="text-center">{{$user->pan ? $user->pan : '--'}}</td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @elseif($user->status == 'D') --}}
                                                            @if($user->created_by==Auth::user()->id)
                                                                <a href="{{route('admin.retail.edituser',['id' => encrypt($user->id)])}}" class="btn btn-success btn-sm">
                                                                    <i class="fa fa-edit"></i>Edit</a>
                                                            @else
                                                                <a href="{{route('admin.retail.existuser_edit',['id' => encrypt($user->id)])}}" class="btn btn-success btn-sm">
                                                                    <i class="fa fa-edit"></i>Edit</a>
                                                            @endif
                                                            {{-- <a class="btn btn-danger btn-sm" onclick="delButtonId({{$user->id}})">
                                                                <i class="fa fa-trash"></i></a> --}}
