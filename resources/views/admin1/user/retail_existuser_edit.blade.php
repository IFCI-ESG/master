    ...
    <div class="container  py-4 px-2 col-lg-12">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="{{ route('admin.retail.existupdate') }}" id="retail_update" role="form" method="post"
                                ...
                                <table class="table table-sm table-striped table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input type="text" id="email" name="email" style="width: 70%" disabled
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input type="text" id="mobile" name="mobile" style="width: 70%" disabled
                                            ...
                                            <td colspan="2">
                                                <div class="row">
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea id="co_off_add" name="address" class="form-control form-control-sm" disabled
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="co_off_pin"
                                                            ...
                                                            <input type="number" min="0" id="co_off_pin" name="pincode" disabled
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm select-state"
                                                            name="state" id="coAddState"  value="{{$user->reg_off_state}}" disabled>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="co_off_city"
                                                            class="col-form-label col-form-label-sm">City</label>
                                                            <select id="coAddCity" name="city" disabled
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.prevent_multiple_submit').on('submit', function() {
                if ($('.det_msg').length === 0) {
                    $( ".prevent_multiple_submit" ).parent().append('<div class="offset-md-4 det_msg"><span class="text-danger text-sm text-center">Please wait while your request is being processed. &nbsp&nbsp&nbsp<i class="fa fa-spinner fa-spin" style="font-size:24px;color:black"></i></span></div>');
                }
