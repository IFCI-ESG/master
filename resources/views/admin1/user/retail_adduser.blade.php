        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="{{ route('admin.retail.apidata') }}" id="user_create" role="form" method="get"
                    class='prevent_multiple_submit_details' files=true enctype='multipart/form-data' accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="card-body m-4">
                             ...
                             <div class="col-md-12">
                                  <a href="{{ asset('csv_sample/retail_upload_Sample.csv') }}">Sample CSV file </a>
                                      ...
                                      <form action="{{ route('admin.company_bulk.retail.store') }}"  role="form" method="post"    class='prevent_multiple_submit-upload' files=true enctype='multipart/form-data' accept-charset="utf-8">
                    @csrf
                        <table class="table">
                            <tbody>
                                <tr>
