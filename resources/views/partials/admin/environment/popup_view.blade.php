...
<form action="{{ route('user.questionnaire.update') }}" id="user_update" role="form" method="post" class='form-horizontal prevent_multiple_submit'
            ...
            <span aria-hidden="true">Close[&times;]</span>
                ...
                <div class="row pb-2">
                    <div class="col-md-2 offset-md-5">
                        {{-- <button type="submit" id="popview_submit" class="btn btn-primary btn-sm form-control form-control-sm"><i
