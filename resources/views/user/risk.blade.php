                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="dashboard-info">
                                <img class="img-responsive img-rounded" src="../assets/images/dashboard-img/thematic-physical.jpg"
                                    alt="700x300">
                                <div class="dashboard-box-info">
                                    {{-- <a href="{{ route('user.thematic') }}" class="btn dashboard-btn">Thematic </a> --}}
                                    <a href="#" class="btn dashboard-btn">Physical Risk</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="dashboard-info">
                                <img class="img-responsive img-rounded" src="../assets/images/dashboard-img/thematic-transition.jpg"
                                    alt="700x300">
                                <div class="dashboard-box-info">
                                    <a href="#" class="btn dashboard-btn">Transition Risk</a>
                                </div>
                            </div>
                        </div>
                    </div>
