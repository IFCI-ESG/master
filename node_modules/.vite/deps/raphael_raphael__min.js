      ...
      return function(t) {
        ...
        i = [r(2)], void 0 === (n = (function(t2) {
          ...
          e2.getRGB = ht(function(t3) {
            if (!t3 || (t3 = x(t3)).indexOf("-") + 1) return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: ut };
            if ("none" == t3) return { r: -1, g: -1, b: -1, hex: "none", toString: ut };
          ...
          function gt(t3, e3, r3, i3, n3, a2, s2, o2) {
            if (!(w(t3, r3) < k(n3, s2) || k(t3, r3) > w(n3, s2) || w(e3, i3) < k(a2, o2) || k(e3, i3) > w(a2, o2))) {
              ...
              if (l2) {
                ...
                if (!(c2 < +k(t3, r3).toFixed(2) || c2 > +w(t3, r3).toFixed(2) || c2 < +k(n3, s2).toFixed(2) || c2 > +w(n3, s2).toFixed(2) || f2 < +k(e3, i3).toFixed(2) || f2 > +w(e3, i3).toFixed(2) || f2 < +k(a2, o2).toFixed(2) || f2 > +w(a2, o2).toFixed(2))) return { x: h2, y: u2 };
              }
            }
          }
          function xt(t3, r3, i3) {
            ...
            for (d2 = 0; d2 < h2 + 1; d2++) g2 = e2.findDotsAtSegment.apply(e2, r3.concat(d2 / h2)), c2.push({ x: g2.x, y: g2.y, t: d2 / h2 });
          ...
          var yt = e2.pathBBox = function(t3) {
            ...
            if (!t3) return { x: 0, y: 0, width: 0, height: 0, x2: 0, y2: 0 };
          ...
          e2._getContainer = function(t3, r3, i3, n3) {
            var a2;
            if (null != (a2 = null != n3 || e2.is(t3, "object") ? t3 : l.doc.getElementById(t3))) return a2.tagName ? null == r3 ? { container: a2, width: a2.style.pixelWidth || a2.offsetWidth, height: a2.style.pixelHeight || a2.offsetHeight } : { container: a2, width: r3, height: i3 } : { container: 1, x: t3, y: r3, width: i3, height: n3 };
          ...
          i2.getElementByPoint = function(t3, e3) {
            ...
            for (var s2 = 1; s2 < r3 + 1; s2++) n3.push(i3.path(a2).attr({ stroke: e3.color, fill: e3.fill ? e3.color : "none", "stroke-linejoin": "round", "stroke-linecap": "round", "stroke-width": +(e3.width / r3 * s2).toFixed(3), opacity: +(e3.opacity / r3).toFixed(3) }));
              ...
              for (var s2, o2, l2, h2, u2, c2 = "", f2 = {}, p2 = 0, d2 = 0, g2 = (i3 = Tt(i3)).length; d2 < g2; d2++) {
                if ("M" == (l2 = i3[d2])[0]) s2 = +l2[1], o2 = +l2[2];
                  ...
                  if (p2 + (h2 = Xt(s2, o2, l2[1], l2[2], l2[3], l2[4], l2[5], l2[6])) > n3) {
                    ...
                    if (!t3 && !r3) return { x: (u2 = Xt(s2, o2, l2[1], l2[2], l2[3], l2[4], l2[5], l2[6], n3 - p2)).x, y: u2.y, alpha: u2.alpha };
                  }
          ...
          function ae(r3, i3, a2, s2, l2, h2) {
            ...
            if (u2) {
              if (c2) c2.initstatus = s2, c2.start = /* @__PURE__ */ new Date() - c2.ms * s2;
                ...
                if (k2 = { anim: r3, percent: a2, timestamp: y2 = u2.start || r3.start || +/* @__PURE__ */ new Date(), start: y2 + (r3.del || 0), status: 0, initstatus: s2 || 0, stop: false, ms: m2, easing: Y2, from: b2, diff: w2, to: _2, el: i3, callback: u2.callback, prev: g2, next: d2, repeat: h2 || r3.times, origin: i3.attr(), totalOrigin: l2 }, Kt.push(k2), s2 && !c2 && !p2 && (k2.stop = true, k2.start = /* @__PURE__ */ new Date() - m2 * s2, 1 == Kt.length)) return ee();
          ...
          Wt.animateWith = function(t3, r3, i3, n3, a2, s2) {
            ...
            if (a2) return i3 && (l2.easing = i3), n3 && (l2.callback = n3), new ne({ 100: l2 }, r3);
            if (n3) {
              var h2 = 0;
              for (var u2 in t3) {
                var c2 = F(u2);
          ...
          return fe.attr = function(t3, r3) {
            ...
            if (this.fonts[r3] ? this.fonts[r3].push(e3) : this.fonts[r3] = [e3], !t3.svg) {
              for (var n3 in e3.face["units-per-em"] = F(t3.face["units-per-em"], 10), t3.glyphs) if (t3.glyphs[o](n3)) {
                ...
                }) + "z" }, a2.k) for (var s2 in a2.k) a2[o](s2) && (e3.glyphs[n3].k[s2] = a2.k[s2]);
              }
            }
            return t3;
        ...
        s = "hasOwnProperty", o = /[\.\/]/, l = /\s*,\s*/, h = function(t2, e2) {
          ...
          for (v = 0; v < y; v++) if ("zIndex" in (r2 = o2[v])) if (r2.zIndex == u2[l2]) {
          ...
          for (var r2 = g(t2) ? g(t2[0]) ? t2 : [t2] : d(t2).split(l), i2 = 0, n2 = r2.length; i2 < n2; i2++) !function(t3) {
            for (var r3, i3 = g(t3) ? t3 : d(t3).split(o), n3 = u, a2 = 0, s2 = i3.length; a2 < s2; a2++) n3 = (n3 = n3.n).hasOwnProperty(i3[a2]) && n3[i3[a2]] || (n3[i3[a2]] = { n: {} });
        ...
        i = [r(0)], void 0 === (n = (function(t2) {
          if (!t2 || t2.svg) {
            ...
            var x = function(i3, n3) {
              ...
              if (!m2) {
                ...
                if (u2 = u2.replace(/[\(\)\s,\xb0#]/g, "_"), e3.gradient && u2 != e3.gradient.id && (g2.defs.removeChild(e3.gradient), delete e3.gradient), !e3.gradient) {
                  ...
                  for (var B2 = 0, C2 = k2.length; B2 < C2; B2++) m2.appendChild(x("stop", { offset: k2[B2].offset ? k2[B2].offset : B2 ? "100%" : "0%", "stop-color": k2[B2].color || "#fff", "stop-opacity": isFinite(k2[B2].opacity) ? k2[B2].opacity : 1 }));
                }
              }
              ...
              if ("path" == i3.type) {
                ...
                } else a2 ? (s2 = i3._.arrows.startdx * b2 || 0, o2 = t2.getTotalLength(m2.path) - s2) : (s2 = 0, o2 = t2.getTotalLength(m2.path) - (i3._.arrows.enddx * b2 || 0)), i3._.arrows[v2 + "Path"] && x(y2, { d: t2.getSubpath(m2.path, s2, o2) }), delete i3._.arrows[v2 + "Path"], delete i3._.arrows[v2 + "Marker"], delete i3._.arrows[v2 + "dx"], delete i3._.arrows[v2 + "Type"], delete i3._.arrows[v2 + "String"];
              ...
              if (e3 = _[r2(e3).toLowerCase()]) {
                for (var n3 = t3.attrs["stroke-width"] || "1", a2 = { round: n3, square: n3, butt: 0 }[t3.attrs["stroke-linecap"] || i3["stroke-linecap"]] || 0, s2 = [], o2 = e3.length; o2--; ) s2[o2] = e3[o2] * n3 + (o2 % 2 ? 1 : -1) * a2;
                x(t3.node, { "stroke-dasharray": s2.join(",") });
              } else x(t3.node, { "stroke-dasharray": "none" });
            }, k = function(i3, a2) {
              ...
              for (var d2 in l2.style.visibility = "hidden", a2) if (a2[e2](d2)) {
                ...
                switch (u2[d2] = g2, d2) {
                  ...
                  case "fill":
                    ...
                    } else delete a2.gradient, delete u2.gradient, !t2.is(u2.opacity, "undefined") && t2.is(a2.opacity, "undefined") && x(l2, { opacity: u2.opacity }), !t2.is(u2["fill-opacity"], "undefined") && t2.is(a2["fill-opacity"], "undefined") && x(l2, { "fill-opacity": u2["fill-opacity"] });
              ...
              if ("text" == i3.type && (a2[e2]("text") || a2[e2]("font") || a2[e2]("font-size") || a2[e2]("x") || a2[e2]("y"))) {
                ...
                if (a2[e2]("text")) {
                  ...
                  for (var h2, u2 = r2(a2.text).split("\n"), f2 = [], p2 = 0, d2 = u2.length; p2 < d2; p2++) h2 = x("tspan"), p2 && x(h2, { dy: 1.2 * l2, x: s2.x }), h2.appendChild(t2._g.doc.createTextNode(u2[p2])), o2.appendChild(h2), f2[p2] = h2;
                } else for (p2 = 0, d2 = (f2 = o2.getElementsByTagName("tspan")).length; p2 < d2; p2++) p2 ? x(f2[p2], { dy: 1.2 * l2, x: s2.x }) : x(f2[0], { dy: 0 });
            ...
            S.prototype = T, T.constructor = S, t2._engine.path = function(t3, e3) {
              ...
              for (null == t3 ? (this._vbSize && (h2 = 1), delete this._vbSize, a2 = "0 0 " + this.width + f + this.height) : (this._vbSize = h2, a2 = t3 + f + e3 + f + r3 + f + i3), x(this.canvas, { viewBox: a2, preserveAspectRatio: p2 }); h2 && c2; ) o2 = "stroke-width" in c2.attrs ? c2.attrs["stroke-width"] : 1, c2.attr({ "stroke-width": o2 }), c2._.dirty = 1, c2._.dirtyT = 1, c2 = c2.prev;
        ...
        i = [r(0)], void 0 === (n = (function(t2) {
          if (!t2 || t2.vml) {
            ...
            var k, B = function(t3, e3, i3) {
              ...
              if ("arrow-start" in l2 && B(T2, l2["arrow-start"]), "arrow-end" in l2 && B(T2, l2["arrow-end"], 1), null != l2.opacity || null != l2.fill || null != l2.src || null != l2.stroke || null != l2["stroke-width"] || null != l2["stroke-opacity"] || null != l2["fill-opacity"] || null != l2["stroke-dasharray"] || null != l2["stroke-miterlimit"] || null != l2["stroke-linejoin"] || null != l2["stroke-linecap"]) {
                ...
                if (!(j = j && j[0]) && (j = k("fill")), "image" == n3.type && l2.src && (j.src = l2.src), l2.fill && (j.on = true), null != j.on && "none" != l2.fill && null !== l2.fill || (j.on = false), j.on && l2.fill) {
                  ...
                  } else j.color = t2.getRGB(l2.fill).hex, j.src = f, j.type = "solid", t2.getRGB(l2.fill).error && (T2.type in { circle: 1, ellipse: 1 } || "r" != r2(l2.fill).charAt()) && S(T2, l2.fill, j) && (g2.fill = "none", g2.gradient = l2.fill, j.rotate = false);
                }
            ...
            T.prototype = A, A.constructor = T, A.transform = function(e3) {
              ...
              if (o2.translate(1, 1), p2 || u2 || "image" == this.type) if (l2.matrix = "1 0 0 1", l2.offset = "0 0", s2 = o2.split(), u2 && s2.noRotation || !s2.isSimple) {
...
export default require_raphael_min();
//# sourceMappingURL=raphael_raphael__min.js.map
