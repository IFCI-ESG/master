...
var require_morris = __commonJS({
  "node_modules/morris.js06/dist/morris.js"(exports) {
    (function() {
      var Morris, compStyle, minutesSpecHelper, secondsSpecHelper, __slice = [].slice, __bind = function(fn, me) {
        return function() {
      ...
      Morris.Grid = function(_super) {
        ...
        Grid.prototype.setData = function(data, redraw) {
          ...
          this.data = (function() {
            var _i2, _len2, _results;
            _results = [];
            for (index = _i2 = 0, _len2 = data.length; _i2 < _len2; index = ++_i2) {
              row = data[index];
              ret = {
                src: row
              };
          ...
          if (this.options.events.length > 0) {
            ...
            flatEvents = this.events.map(function(e2) {
              return e2;
            });
        ...
        Grid.prototype.yAxisFormat2 = function(label) {
          return this.yLabelFormat(label, 1e3);
        };
                  ...
                  if (this.options.lineColors != null && this.options.lineType != null) {
                    ...
                    if (row._y2 != null) {
                      if (row._y2[index] != null) {
                        _results1.push(this.drawDataLabel(row._x, row._y2[index] - 10, this.yLabelFormat_noUnit(row.y[index], 1e3), color));
                      } else {
      ...
      Morris.Line = function(_super) {
        ...
        Line.prototype.calcPoints = function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            row._y = (function() {
              var _j2, _len12, _ref12, _results2;
              _ref12 = row.y;
              _results2 = [];
              for (ii = _j2 = 0, _len12 = _ref12.length; _j2 < _len12; ii = ++_j2) {
                y = _ref12[ii];
                if (ii < this.options.ykeys.length - this.options.nbYkeys2) {
                  if (y != null) {
                    _results2.push(this.transY(y));
                  } else {
                    _results2.push(y);
                  }
                } else {
            ...
            row._ymax = Math.min.apply(Math, [this.bottom].concat((function() {
              ...
              _ref12 = row._y;
              _results2 = [];
              for (i = _j2 = 0, _len12 = _ref12.length; _j2 < _len12; i = ++_j2) {
                y = _ref12[i];
          ...
          if (this.options.pointSuperimposed === false) {
            _ref3 = this.data;
            _results = [];
        ...
        Line.prototype.drawXAxis = function() {
          var drawLabel, l, labels, lines, prevAngleMargin, prevLabelMargin, row, ypos, _i, _j, _len, _len1, _results, _this = this;
        ...
        Line.prototype.drawLinePath = function(path, lineColor, lineIndex) {
          ...
          if (this.options.animate) {
            ...
            if (this.options.cumulative) {
              return function(rPath2, path2) {
                return rPath2.animate({
                  path: path2
                }, 600, "<>");
              }(rPath, path);
            } else {
      ...
      Morris.Area = function(_super) {
        ...
        Area.prototype.calcPoints = function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            row._y = (function() {
              ...
              _ref12 = row.y;
              _results2 = [];
              for (_j2 = 0, _len12 = _ref12.length; _j2 < _len12; _j2++) {
                y = _ref12[_j2];
                if (this.options.behaveLikeLine) {
                  ...
                  if (y != null) {
                    total += y || 0;
                    _results2.push(this.transY(total));
                  } else {
                    _results2.push(void 0);
                  }
                }
        ...
        Area.prototype.drawSeries = function() {
          ...
          if (this.options.behaveLikeLine) {
            range = (function() {
              _results = [];
              for (var _i2 = 0, _ref2 = this.options.ykeys.length - 1; 0 <= _ref2 ? _i2 <= _ref2 : _i2 >= _ref2; 0 <= _ref2 ? _i2++ : _i2--) {
                _results.push(_i2);
              }
              return _results;
            }).apply(this);
            ...
            range = (function() {
              _results1 = [];
              for (var _j2 = _ref1 = this.options.ykeys.length - 1; _ref1 <= 0 ? _j2 <= 0 : _j2 >= 0; _ref1 <= 0 ? _j2++ : _j2--) {
                _results1.push(_j2);
              }
              return _results1;
            }).apply(this);
      ...
      Morris.Bar = function(_super) {
        ...
        Bar.prototype.draw = function() {
          ...
          this.drawSeries();
          if (this.options.rightAxisBar === false) {
            this.drawBarLine();
        ...
        Bar.prototype.drawBarLine = function() {
          ...
          for (ii = _i = 0, _len = _ref.length; _i < _len; ii = _i += 1) {
            ...
            if (this.options.horizontal === false) {
              coords = (function() {
                var _j2, _len12, _ref1, _results1;
                _ref1 = this.data;
                _results1 = [];
                for (_j2 = 0, _len12 = _ref1.length; _j2 < _len12; _j2++) {
                  r = _ref1[_j2];
            ...
            for (i = _j = 0, _len1 = coords.length; _j < _len1; i = ++_j) {
              ...
              if (coord.y != null) {
                if (prevCoord.y != null) {
                  if (this.options.smooth && this.options.horizontal === false) {
                    g = grads[i];
                    lg = grads[i - 1];
                    ix = (coord.x - prevCoord.x) / 4;
                    x1 = prevCoord.x + ix;
            ...
            if (path !== "") {
              if (this.options.animate) {
                ...
                _results.push(function(rPath2, path2) {
                  return rPath2.animate({
                    path: path2
                  }, 500, "<>");
                }(rPath, path));
        ...
        Bar.prototype.drawXAxis = function() {
          ...
          for (i = _i = 0, _ref = this.data.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
            ...
            label.transform("t0," + labelBox.height / 2 + "...");
            if (angle !== 0) {
              offset = -0.5 * textBox.width * Math.cos(angle * Math.PI / 180);
              label.transform("t" + offset + ",0...");
            }
            ...
            if ((prevLabelMargin == null || prevLabelMargin >= startPos + size || prevAngleMargin != null && prevAngleMargin >= startPos) && startPos >= 0 && startPos + size < maxSize) {
              if (angle !== 0) {
                margin = 1.25 * this.options.gridTextSize / Math.sin(angle * Math.PI / 180);
        ...
        Bar.prototype.drawSeries = function() {
          ...
          if (this.options.stacked === false && this.options.rightAxisBar === false) {
            ...
            if (this.options.dataLabels && this.values.length >= 1) {
              ...
              if (this.options.dataLabelsPosition === "inside") {
                if (this.options.donutType === "pie") {
                  label_x = parseFloat(cx) + parseFloat(dist * 0.3 * p_sin_p0);
                  label_y = parseFloat(cy) + parseFloat(dist * 0.3 * p_cos_p0);
                } else {
...
export default require_morris();
/*! Bundled license information:

morris.js06/dist/morris.js:
  (* @license
  morris.js06 v0.6.9 
  ...
  *)
*/
//# sourceMappingURL=morris__js06_dist_morris.js.map
