...
Route::post('thematic/update', [\App\Http\Controllers\User\ThematicController::class,'update'])->name('thematic.update');
    ...
    Route::get('questionnaire/{bank_id}/{class_type}/{fy_id}', [\App\Http\Controllers\User\UserController::class,'addquestionnaire'])->name('addquestionnaire');
   ...
   Route::get('questionnaire_view/{bank_id}/{class_type}/{com_id}/{fy_id}', [\App\Http\Controllers\User\UserController::class,'view'])->name('questionnaire_view');
