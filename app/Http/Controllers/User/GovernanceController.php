...
use App\GovernanceQuestionMaster;
use App\GovernanceQuestionValue;
use App\GovernanceMast;
use App\User;
...
class GovernanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.governance.index_new', compact('quesMast','user','fys','gov_mast','gov_value'));
    ...
    public function create($fy_id)
    {
        ...
        return view('user.governance.create_new', compact('quesMast','user','fys','fy_id','gov_mast'));
    }
